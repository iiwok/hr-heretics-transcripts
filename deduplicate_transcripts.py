#!/usr/bin/env python3
"""
Deduplicate transcript files by removing consecutive duplicate lines.
"""
...
def process_episodes(episodes_dir):
    ...
    for episode_dir in sorted(episodes_path.iterdir()):
        ...
        try:
            ...
            # Deduplicate
            deduplicated = deduplicate_lines(original)
...
if __name__ == '__main__':
    ...
    print(f"Deduplicating transcripts in: {episodes_dir}\n")
